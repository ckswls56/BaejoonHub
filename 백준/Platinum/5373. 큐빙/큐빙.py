    ...
    for order in orders:
        ...
        if side == 'U':
            if turn == '+':
                ...
                up[0][0], up[0][1], up[0][2], up[1][2], up[2][2], up[2][1], up[2][0], up[1][0] = up[0][2], up[1][2], up[2][2], up[2][1], up[2][0], up[1][0], up[0][0], up[0][1]
        ...
        if side == 'D':
            if turn == '+':
                ...
                down[0][0], down[0][1], down[0][2], down[1][2], down[2][2], down[2][1], down[2][0], down[1][0] = down[0][2], down[1][2], down[2][2], down[2][1], down[2][0], down[1][0], down[0][0], down[0][1]
        ...
        if side == 'F':
            if turn == '+':
                ...
                front[0][0], front[0][1], front[0][2], front[1][2], front[2][2], front[2][1], front[2][0], front[1][0] = front[0][2], front[1][2], front[2][2], front[2][1], front[2][0], front[1][0], front[0][0], front[0][1]
        ...
        if side == 'B':
            if turn == '+':
                ...
                back[0][0], back[0][1], back[0][2], back[1][2], back[2][2], back[2][1], back[2][0], back[1][0] = back[0][2], back[1][2], back[2][2], back[2][1], back[2][0], back[1][0], back[0][0], back[0][1]
        ...
        if side == 'L':
            if turn == '+':
                ...
                left[0][0], left[0][1], left[0][2], left[1][2], left[2][2], left[2][1], left[2][0], left[1][0] = left[0][2], left[1][2], left[2][2], left[2][1], left[2][0], left[1][0], left[0][0], left[0][1]
        ...
        if side == 'R':
            if turn == '+':
                ...
                right[0][0], right[0][1], right[0][2], right[1][2], right[2][2], right[2][1], right[2][0], right[1][0] = right[0][2], right[1][2], right[2][2], right[2][1], right[2][0], right[1][0], right[0][0], right[0][1]
